package com.bluetooth.bluelibrary;
...
import com.bluetooth.bluelibrary.broadcasts.BluetoothBroadcastReceiver;
import com.bluetooth.bluelibrary.broadcasts.BluetoothPairingReceiver;
import com.bluetooth.bluelibrary.broadcasts.BluetoothStateReceiver;
import com.bluetooth.bluelibrary.broadcasts.FoundDeviceReceiver;
import com.bluetooth.bluelibrary.dialogs.DeviceDialog;
import com.bluetooth.bluelibrary.handlers.BluetoothHandler;
import com.bluetooth.bluelibrary.handlers.DefaultBluetoothHandler;
...
public class SimpleBluetooth {
    ...
    /**
     * {@link SimpleBluetoothListener} for SimpleBluetooth
     */
     ...
     */
    public void setInputStreamType(BluetoothUtility.InputStreamType type) {
        this.curType = type;
    }
...
//        Log.d("SIMPLEBT", "Sending data: " + data);
    ...
    public void connectToBluetoothDevice(String macAddress) {
        if(!isInitialized) {
            Toast.makeText(mContext, "Bluetooth not initialized. Please try again.", Toast.LENGTH_SHORT).show();
            mListener.onBluetoothNotInitialized();
            //mContext.
