package com.bluetooth.bluelibrary.dialogs;
...
import com.bluetooth.bluelibrary.utils.BluetoothDeviceListAdapter;
...
public class DeviceDialog extends BaseBluetoothActivity implements FoundDeviceReceiver.FoundDeviceReceiverCallBack {
    ...
    public static final String DEVICE_DIALOG_DEVICE_NAME_EXTRA = "deviceDialogDeviceNameExtra";
    ...
    private void populateList() {
        ...
        bdla = new BluetoothDeviceListAdapter(this,
                R.layout.bluetooth_list_item_layout, devices);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (checkDevicePaired(selectedDevice)) {
                    ...
                    data.putExtra(DEVICE_DIALOG_DEVICE_NAME_EXTRA, selectedDevice.getName());
